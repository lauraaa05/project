...
function App() {
  ...
  return (
    <>
        <input value={myForm.title} onChange={e => setMyForm({...myForm, title: e.target.value})} placeholder="Interesting title"/>
        <input value={myForm.description} onChange={e => setMyForm({...myForm, description: e.target.value})} placeholder="Interesting description"/>
